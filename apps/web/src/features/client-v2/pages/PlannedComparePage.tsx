  ...
  return (
    <div className="flex flex-col gap-3 px-5 pb-3.5 pt-1.5">
      <div className="flex items-center gap-2.5">
        <button type="button" onClick={() => navigate(`/planned/${id}`)} className="text-xl text-primary">
          ←
        </button>
        <span className="text-lg font-extrabold text-ink">{t('plannedDetail.compareTitle')}</span>
      </div>
      <div className="overflow-x-auto">
        <table className="w-full min-w-[420px] border-collapse overflow-hidden rounded-lg border border-border text-[12.5px]">
          <thead>
            <tr>
