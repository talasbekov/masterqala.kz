  ...
  return (
    <div className="flex flex-col gap-3.5 px-5 pb-3.5 pt-1.5">
      ...
      >
        ...
        <div className="mt-1.5 text-[12.5px] leading-snug text-ink-soft">{t('home.urgentDescription')}</div>
      ...
      <div className="flex items-center gap-2.5 rounded-md bg-fill px-3.5 py-3">
        ...
        <div className="text-xs font-semibold leading-snug text-ink">{t('home.trustBanner')}</div>
      </div>
    </div>
  );
}
