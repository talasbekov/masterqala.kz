  ...
  return (
    <div className="flex min-h-screen flex-col gap-3 px-5 pb-3.5 pt-1.5">
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-3 text-center">
        ...
        <div className="text-base font-extrabold text-ink">{t('payments.comingSoon')}</div>
        <p className="max-w-[260px] text-xs leading-relaxed text-ink-soft">{t('payments.note')}</p>
      </div>
    </div>
  );
}
